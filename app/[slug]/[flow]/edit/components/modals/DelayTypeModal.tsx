              ...
              >
                <div 
                  ...
                  style={{
                    borderColor: colors['border-primary'],
                    backgroundColor: colors['bg-secondary'],
                    color: selectedType ? colors['text-primary'] : colors['text-tertiary'],
                  }}
                >
                  <span className="text-sm font-normal text-left" style={{ color: colors['text-primary'] }}>{getDelayTypeDisplayText(selectedType)}</span>
                  <div 
                ...
                >
                  ...
                  >
                    <div 
                      ...
                      style={{ 
                        backgroundColor: selectedType === DelayType.FIXED_DURATION 
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm font-normal text-left" style={{ color: colors['text-primary'] }}>
                          Fixed Duration
                        </div>
                      </div>
                      {selectedType === DelayType.FIXED_DURATION && (
                        <div className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center" style={{ backgroundColor: `${colors['accent-primary']}20` }}>
                          <img 
                  ...
                  >
                    <div 
                      className="flex items-center justify-between w-full rounded-[6px] py-[10px] px-[10px] pl-[8px]"
                      style={{ 
                        backgroundColor: selectedType === DelayType.WAIT_FOR_EVENT 
                          ? `${colors['accent-primary']}15`
                          : 'transparent'
                      }}
                    >
