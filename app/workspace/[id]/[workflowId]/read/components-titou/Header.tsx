  ...
  const exampleMessages = [
    {
      ...
      message: 'Hey! I think the 1st step should be more direct. Here is an example',
    ...
    },
    {
      ...
      user: {
        name: 'You',
        avatar: user.avatar_url || `${process.env.NEXT_PUBLIC_SUPABASE_URL}${process.env.NEXT_PUBLIC_SUPABASE_STORAGE_PATH}/assets/shared_components/default-avatar.svg`,
      },
