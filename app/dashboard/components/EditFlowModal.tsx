  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="w-[550px] rounded-xl shadow-lg flex-col justify-start items-center flex overflow-hidden relative z-10"
      ...
      >
        ...
        <div className="self-stretch px-6 pt-6 flex-col justify-start items-start gap-5 flex">
