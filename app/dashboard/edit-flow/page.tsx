            ...
            <div className="h-[446px] bg-white rounded-xl shadow-[0px_8px_8px_-4px_rgba(16,24,40,0.03)] shadow-[0px_20px_24px_-4px_rgba(16,24,40,0.08)] flex-col justify-start items-center flex overflow-hidden relative z-10">
                ...
                <div className="self-stretch h-40 flex-col justify-start items-center flex">
                    <div className="self-stretch h-[140px] px-6 pt-6 flex-col justify-start items-start gap-4 flex">
                        <div className="w-12 h-12 p-3 bg-white rounded-[10px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] border border-[#e4e7ec] justify-center items-center inline-flex overflow-hidden">
                            ...
                            <img src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}${process.env.NEXT_PUBLIC_SUPABASE_STORAGE_PATH}/assets/shared_components/layers-three-01.svg`} 
                                alt="Flow icon" 
                                className="w-6 h-6"/>
                        </div>
                        </div>
                        <div className="self-stretch h-[52px] flex-col justify-start items-start gap-1 flex">
                            <div className="self-stretch text-[#101828] text-lg font-semibold font-['Inter'] leading-7">Edit a Flow</div>
                            <div className="self-stretch text-[#475467] text-sm font-normal font-['Inter'] leading-tight">Edit your Flow’s name</div>
                        </div>
                    </div>
                ...
                <div className="self-stretch h-[186px] px-6 flex-col justify-start items-start gap-5 flex">
                    <div className="self-stretch h-[70px] flex-col justify-start items-start gap-3 flex">
                        <div className="justify-start items-start gap-0.5 inline-flex">
                            <div className="text-[#344054] text-sm font-semibold font-['Inter'] leading-tight">Process name</div>
                            <div className="text-[#4761c4] text-sm font-medium font-['Inter'] leading-tight">*</div>
                        </div>
                        <input 
                    ...
                    <div className="self-stretch h-24 flex-col justify-start items-start gap-1.5 flex">
                        <div className="text-[#344054] text-sm font-semibold font-['Inter'] leading-tight">Flow description</div>
                        <textarea 
                ...
                <div className="self-stretch h-[100px] pt-8 flex-col justify-start items-start flex">
                    <div className="self-stretch px-6 pb-6 justify-start items-start gap-3 inline-flex">
                        <button className="grow shrink basis-0 h-11 px-4 py-2.5 bg-white rounded-lg border border-[#d0d5dd] text-[#344054] text-base font-semibold transition duration-300 hover:bg-[#F9FAFB]">Discard changes</button>
                        <button className="grow shrink basis-0 h-11 px-4 py-2.5 bg-[#4e6bd7] rounded-lg border-2 border-white text-white text-base font-semibold transition duration-300 hover:bg-[#374C99]">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
