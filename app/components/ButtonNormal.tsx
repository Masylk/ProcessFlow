...
const ButtonNormal: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: {
      light: 'text-white bg-lightMode-button-primary-bg hover:bg-lightMode-button-primary-bg_hover border border-lightMode-shadow-skeumorphic-inner hover:border-lightMode-shadow-skeumorphic-inner-border shadow-[inset_0_-2px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-lightMode-bg-primary focus-visible:ring-lightMode-button-primary-bg',
      dark: 'text-white bg-lightMode-button-primary-bg hover:bg-lightMode-button-primary-bg_hover border border-lightMode-shadow-skeumorphic-inner hover:border-lightMode-shadow-skeumorphic-inner-border shadow-[inset_0_-2px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-darkMode-bg-primary focus-visible:ring-darkMode-button-primary-bg',
    },
    secondaryGray: {
      light: 'text-lightMode-button-secondary-fg hover:text-lightMode-text-secondary_hover bg-white hover:bg-lightMode-button-secondary-bg_hover border border-lightMode-button-secondary-border shadow-[inset_0_-2px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-lightMode-bg-primary focus-visible:ring-lightMode-button-primary-bg',
      dark: 'text-darkMode-button-secondary-fg hover:text-darkMode-text-secondary_hover bg-darkMode-button-secondary-bg hover:bg-darkMode-button-secondary-bg_hover border border-darkMode-button-secondary-border shadow-[inset_0_-2px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-darkMode-bg-primary focus-visible:ring-darkMode-button-primary-bg',
    },
    secondaryColor: {
      light: 'text-lightMode-button-secondary-color-fg hover:text-lightMode-button-secondary-color-fg_hover bg-white hover:bg-lightMode-button-secondary-color-bg_hover border border-lightMode-button-secondary-color-border hover:border-lightMode-button-secondary-color-border_hover shadow-[inset_0_-1px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(136,156,228,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-lightMode-bg-primary focus-visible:ring-lightMode-button-primary-bg',
      dark: 'text-darkMode-button-secondary-color-fg hover:text-darkMode-button-secondary-color-fg_hover bg-darkMode-button-secondary-color-bg hover:bg-darkMode-button-secondary-color-bg_hover border border-darkMode-button-secondary-color-border hover:border-darkMode-button-secondary-color-border_hover shadow-[inset_0_-2px_0_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(0,0,0,0.2)] focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-offset-darkMode-bg-primary focus-visible:ring-darkMode-button-primary-bg',
    },
    tertiaryGray: {
